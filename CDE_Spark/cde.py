...
# input dir
input_dir = "E:\\data\\BaiduYunDownload\\PySpark_CDE\\PySpark_CDE\\04-18\\Example_data\\Example_data\\"
# output dir
output_dir = "./output"
...
def main():
    ...
    print "Your take {} seconds",start_time - time.time()
    # update meta
    ...
    for i, adaf_obj in enumerate(processed_adaf_objs):
        print( new_dat_list[i], input_dir, output_dir)
