...
# generate_uuid.counter = 0L
# generate_uuid.memory = set()
# generate_uuid.new_uuid = lambda: unicode(u'{{{}}}'.format(uuid.uuid1(
#     clock_seq=generate_uuid.counter)))
generate_uuid.new_uuid = lambda: unicode(u'{{{}}}'.format(uuid.uuid4()))
