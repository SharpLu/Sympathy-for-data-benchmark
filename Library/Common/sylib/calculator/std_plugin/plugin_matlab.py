...
STATISTICS = [
    ...
    ("Min", "min(${signal0})",
     ...
     "This MATLAB function returns the smallest elements of A.If A is a vector,"
     " then \n min(A) returns the smallest element of A.If A is a matrix, "
     "then min(A) treats \n the columns of A as vectors and returns a row "
     "vector of smallest elements.If A \n is a multidimensional array, "
